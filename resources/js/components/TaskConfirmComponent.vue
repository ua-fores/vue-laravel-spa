            ...
            <div class="col-sm-6">
                ...
                <form v-on:submit.prevent="submit">
                    <div class="form-group row">
                        ...
                        <p type="text" class="col-sm-9 form-control-plaintext" readonly id="id" v-model="task.id">
                    </div>
                    <div class="form-group row">
                        <label for="title" class="col-sm-3 col-form-label">Title</label>
                        <p type="text" class="col-sm-9 form-control" readonly id="title">
                    </div>
                    <div class="form-group row">
